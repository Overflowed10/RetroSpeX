...
<?php function showKalm($url_params){
    $db = new Database();
    $pdo = $db->connect();
            ...
            <div class="row justify-content-center">
                <div class="card-deck">
                    ...
                    <div id="card-deck2">
                        <div class="kalm-card">
                            <div class="card-body text-center">
                                <a class="card-link" href="#question2">
                                    ADD</a>
                                <div class="container text-center cardSum">
                                    <?php 
                                        if (array_key_exists(6, $counts)){
                                            echo $counts[$questions[1]["id"]];
                                        } else {
                                            echo "0";
                                        }
                                    ?>
                    ...
                    <div id="card-deck3">
                        <div class="kalm-card">
                            <div class="card-body text-center">
                                <a class="card-link" href="#question3">
                                    LESS</a>
                                <div class="container text-center cardSum">
                                    <?php 
                                        if (array_key_exists(7, $counts)){
                                            echo $counts[$questions[2]["id"]];
                                        } else {
                                            echo "0";
                                        }
                                    ?>
                    ...
                    <div id="card-deck4">
                        <div class="kalm-card">
                            <div class="card-body text-center">
                                <a class="card-link" href="#question4">
                                    MORE</a>
                                <div class="container text-center cardSum">
                                    <?php 
                                        if (array_key_exists(8, $counts)){
                                            echo $counts[$questions[3]["id"]];
                                        } else {
                                            echo "0";
                                        }
                                    ?>
